...
function PCMarketTest() {
  ...
  return (
    <div className='cardStyle'>
        ...
        <label>Beat Name</label><DropdownTest options={beatList.current} onSelect={handleBeatChange}/>
